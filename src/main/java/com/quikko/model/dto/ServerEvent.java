...
/**
 * Generic outbound envelope pushed to a client's private topic ({@code /topic/session/{anonId}}).
 * Only the fields relevant to {@link #type} are populated; the rest are left null and omitted from the serialized JSON (see spring.jackson.default-property-inclusion=non_null).
 */
