...
/**
 * Relays WebRTC offer/answer/ICE-candidate payloads between the two peers of a live pair.
 * The server never inspects or modifies the SDP/ICE content.
 * It only validates that the sender is actually part of the pairId claimed before forwarding.
 */
@Controller
