...
/**
 * Tracks the mapping between a raw STOMP session id and the anonymous id the client announced on it, plus the IP address captured at handshake time.
 * Populated on queue.join, consulted on disconnect and on Report.
 */
@Component
