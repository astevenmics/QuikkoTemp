...
/**
 * Cleans up queue/pair state when a browser tab closes or the socket drops
 * without an explicit Stop — otherwise the other side would be left
 * waiting forever on a partner who is gone.
 */
@Component
