...
/**
 * Small read-only config endpoints the frontend fetches on load:
 * suggested interest tags (Common Ground) and the WebRTC ICE server list (STUN always,TURN only if configured via environment variables).
 */
@RestController
