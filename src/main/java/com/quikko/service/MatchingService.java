...
/**
 * Owns the waiting queue and the pairing algorithm: prefer a partner who
 * shares at least one interest tag; if no such partner is available within
 * {@code quikko.matching.fallback-after-seconds}, pair with anyone waiting
 * (randomness-vs-relevance fallback).
 */
@Service
public class MatchingService {
    ...
    /**
     * Ends the pair (if the caller is actually part of it), removes it from
     * the store, and notifies the other side. The partner is never
     * auto-requeued here — Skip/Stop/Report handlers decide what happens
     * next for each side individually.
     */
