...
/**
 * Sends a {@link ServerEvent} to a specific anonymous session's private topic.
 * There is no Spring Security Principal in this app (no accounts), so per-user targeting is done by topic name instead of {@code convertAndSendToUser}.
 */
@Service
