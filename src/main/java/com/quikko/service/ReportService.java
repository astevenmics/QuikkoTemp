...
/**
 * Tracks one-tap Reports and applies temporary IP bans once a session's
 * report count crosses the configured threshold.
 */
@Service
public class ReportService {
    ...
    /**
     * Records a report against the given IP and bans it if the threshold is
     * reached. Returns true if this report caused a ban.
     */
