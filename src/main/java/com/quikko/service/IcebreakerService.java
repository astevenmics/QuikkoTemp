...
/**
 * Produces the top-banner icebreaker text: a tailored prompt when two strangers share an interest tag ("Common Ground"),
 * otherwise a generic random conversation-starter.
 */
@Service
